...
function HTS_Info(props) {    
    ...
    const getHTS_uses = async() => {
        await axios.get(API_URL+"/hts_uses").then(res => setHTS_uses( res.data ));
       };
            ...
            <div id="HTS_info">
                ...
                <div id="HTS" class="row  mb-5 form_section shadow-sm bg-white rounded p-4">
                    ...
                    <div class="form-group col-md-4 mb-4">
                        ...
                        <Input id="hts_use" name="hts_use" type="select" value={props.facility_data.hts_use}
                            className={ props.Original_data && props.Original_data.hts_use != props.facility_data.hts_use && "highlight_changed_data"}
                            onChange={(e) => props.setFacility_data({...props.facility_data, "hts_use":e.target.value})}>
                                { 
                                HTS_uses.map(type => (    
                    ...
                    <div class="form-group col-md-4 mb-4">
                        ...
                        <Input id="hts_deployment" name="hts_deployment" type="select" value={props.facility_data.hts_deployment}
                    ...
                    <div class="form-group col-md-4 mb-4">
                        ...
                        <Input id="hts_status" name="hts_status" type="select" value={props.facility_data.hts_status}
